...
/*     */   
/*     */   public aiy(Schema ☃, boolean bool) {
/*  22 */     super(☃, bool);
/*     */   }
/*     */   static {
/*  25 */     a = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), ☃ -> {
...
/* 345 */     return (String)a.get(☃);
/*     */   }
/*     */ 
/*     */   
/*     */   public TypeRewriteRule makeRule() {
/* 350 */     Type<Either<Integer, Pair<String, String>>> ☃ = DSL.or(DSL.intType(), DSL.named(akn.r.typeName(), aln.a()));
/* 351 */     Type<Pair<String, String>> type = DSL.named(akn.r.typeName(), aln.a());
/* 352 */     OpticFinder<Either<Integer, Pair<String, String>>> opticFinder = DSL.fieldFinder("id", ☃);
/* 353 */     return fixTypeEverywhereTyped("ItemIdFix", getInputSchema().getType(akn.l), getOutputSchema().getType(akn.l), typed -> typed.update(☃, type, ()));
/*     */   }
/*     */ }


/* Location:              C:\Users\Georg\OneDrive\Minecraft\Desktop\Minecraft\1.16.4.zip!\aiy.class
