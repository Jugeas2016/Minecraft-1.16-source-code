...
/*     */ 
/*     */   
/*  60 */   private final PriorityQueue<c.a> b = Queues.newPriorityQueue();
/*     */   private final Queue<dzt> c;
/*  62 */   private final Queue<Runnable> d = Queues.newConcurrentLinkedQueue();
/*     */   
...
/*     */   private brx j;
/*     */   private final eae k;
/*  72 */   private dcn l = dcn.a;
/*     */   
/*     */   public ecu(brx ☃, eae eae1, Executor executor, boolean bool, dzt dzt1) {
/*  75 */     this.j = ☃;
/*  76 */     this.k = eae1;
/*     */ 
/*     */ 
/*     */     
/*  80 */     int i = Math.max(1, (int)(Runtime.getRuntime().maxMemory() * 0.3D) / eao.u().stream().mapToInt(eao::v).sum() * 4 - 1);
/*  81 */     int j = Runtime.getRuntime().availableProcessors();
/*  82 */     int k = bool ? j : Math.min(j, 4);
/*  83 */     int m = Math.max(1, Math.min(k, i));
/*     */ 
/*     */     
/*  86 */     this.g = dzt1;
/*     */     
/*  88 */     List<dzt> list = Lists.newArrayListWithExpectedSize(m);
/*     */     try {
/*  90 */       for (int n = 0; n < m; n++) {
/*  91 */         list.add(new dzt());
/*     */       }
/*  93 */     } catch (OutOfMemoryError outOfMemoryError) {
/*  94 */       a.warn("Allocated only {}/{} buffers", Integer.valueOf(list.size()), Integer.valueOf(m));
/*     */       
/*  96 */       int n = Math.min(list.size() * 2 / 3, list.size() - 1);
/*  97 */       for (int i1 = 0; i1 < n; i1++) {
/*  98 */         list.remove(list.size() - 1);
/*     */       }
/* 100 */       System.gc();
/*     */     } 
/*     */     
/* 103 */     this.c = Queues.newArrayDeque(list);
/* 104 */     this.f = this.c.size();
/*     */     
/* 106 */     this.i = executor;
/* 107 */     this.h = aoe.a(executor, "Chunk Renderer");
/* 108 */     this.h.a(this::h);
/*     */   }
/*     */ 
/*     */ 
...
/*     */       return;
/*     */     }
/* 130 */     dzt dzt1 = this.c.poll();
/* 131 */     this.e = this.b.size();
/* 132 */     this.f = this.c.size();
/*     */ 
/*     */     
/* 135 */     CompletableFuture.runAsync(() -> { 
/* 136 */         }this.i).thenCompose(void_ -> ☃.a(dzt1))
/* 137 */       .whenComplete((a1, throwable) -> {
/*     */           if (throwable != null) {
/*     */             l l = l.a(throwable, "Batching chunks");
/*     */             djz.C().a(djz.C().c(l));
/*     */             return;
/*     */           } 
/*     */           this.h.a(());
...
/*     */   
/*     */   public String b() {
/* 157 */     return String.format("pC: %03d, pU: %02d, aB: %02d", new Object[] { Integer.valueOf(this.e), Integer.valueOf(this.d.size()), Integer.valueOf(this.f) });
/*     */   }
/*     */   
/*     */   public void a(dcn ☃) {
/* 161 */     this.l = ☃;
...
/*     */     
/*     */     Runnable runnable;
/* 172 */     while ((runnable = this.d.poll()) != null) {
/* 173 */       runnable.run();
/* 174 */       ☃ = true;
/*     */     } 
/*     */     
...
/*     */   }
/*     */   
/*     */   public CompletableFuture<Void> a(dfh ☃, dfp dfp1) {
/* 198 */     return CompletableFuture.runAsync(() -> {  }this.d::add).thenCompose(void_ -> b(☃, dfp1));
/*     */   }
/*     */   
/*     */   private CompletableFuture<Void> b(dfh ☃, dfp dfp1) {
/* 202 */     return dfp1.b(☃);
/*     */   }
/*     */   
/*     */   private void i() {
/* 206 */     while (!this.b.isEmpty()) {
/* 207 */       c.a ☃ = this.b.poll();
/* 208 */       if (☃ != null) {
/* 209 */         ☃.a();
/*     */       }
...
/*     */   
/*     */   public boolean f() {
/* 216 */     return (this.e == 0 && this.d.isEmpty());
/*     */   }
/*     */   
/*     */   public void g() {
/* 220 */     i();
...
/* 222 */     this.c.clear();
/*     */   }
/*     */   public class c { public final AtomicReference<ecu.b> a; @Nullable
/*     */     private b d; @Nullable
/*     */     private c e; private final Set<ccj> f; private final Map<eao, dfp> g; public dci b; private int h; private boolean i; private final fx.a j; private final fx.a[] k; private boolean l;
/*     */     public c(ecu ☃) {
...
/*     */       public int a(a ☃)
/*     */       {
/* 629 */         return Doubles.compare(this.a, ☃.a); } } } abstract class a implements Comparable<c.a> { protected final double a; public int a(a ☃) { return Doubles.compare(this.a, ☃.a); }
/*     */      protected final AtomicBoolean b = new AtomicBoolean(false); public a(ecu this$0, double ☃) {
/*     */       this.a = ☃;
/*     */     }
/*     */     public abstract CompletableFuture<ecu.a> a(dzt param1dzt);
/*     */     public abstract void a(); }
/* 635 */   enum a { a,
/* 636 */     b; }
/*     */ 
...
/* Location:              C:\Users\Georg\OneDrive\Minecraft\Desktop\Minecraft\1.16.4.zip!\ecu.class
