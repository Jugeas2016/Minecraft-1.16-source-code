...
/*     */   
/*  39 */   public static final vk a = new vk("minecraft", "missing");
/*     */   
/*     */   private final dmw c;
/*  42 */   private final Map<vk, dmw> d = Maps.newHashMap();
/*     */   private final ekd e;
/*  44 */   private Map<vk, vk> f = (Map<vk, vk>)ImmutableMap.of();
/*     */ 
/*     */   
/*     */   private final acc g;
/*     */ 
/*     */   
/*     */   public dmv(ekd ☃) {
/*  51 */     this.g = new ack<Map<vk, List<deb>>>(this)
/*     */       {
...
/*     */       };
/*     */     this.e = ☃;
/*     */     this.c = x.<dmw>a(new dmw(☃, a), ☃ -> ☃.a(Lists.newArrayList((Object[])new deb[] { new dmu() })));
/*     */   } public void a(Map<vk, vk> ☃) {
/* 156 */     this.f = ☃;
/*     */   }
/*     */   
/*     */   public dku a() {
/* 160 */     return new dku(☃ -> (dmw)this.d.getOrDefault(this.f.getOrDefault(☃, ☃), this.c));
/*     */   }
/*     */   
/*     */   public acc b() {
/* 164 */     return this.g;
...
/*     */   
/*     */   public void close() {
/* 169 */     this.d.values().forEach(dmw::close);
/* 170 */     this.c.close();
/*     */   }
/*     */ }


/* Location:              C:\Users\Georg\OneDrive\Minecraft\Desktop\Minecraft\1.16.4.zip!\dmv.class
