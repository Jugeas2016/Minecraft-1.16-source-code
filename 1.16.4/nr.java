...
/*     */             return b;
/*     */           }
/*     */           stringBuilder.append((str.length() <= i) ? str : str.substring(0, i));
...
/*     */ 
/*     */   
/*     */   default <T> Optional<T> a(nu.b<T> ☃, ob ob1) {
/*  77 */     ob ob2 = c().a(ob1);
/*     */     
/*  79 */     Optional<T> optional = b(☃, ob2);
/*  80 */     if (optional.isPresent()) {
/*  81 */       return optional;
/*     */     }
/*     */     
/*  84 */     for (nr nr1 : b()) {
/*  85 */       Optional<T> optional1 = nr1.a(☃, ob2);
/*  86 */       if (optional1.isPresent()) {
/*  87 */         return optional1;
/*     */       }
/*     */     } 
/*     */     
...
/*     */ 
/*     */   
/*     */   default <T> Optional<T> a(nu.a<T> ☃) {
/*  96 */     Optional<T> optional = b(☃);
/*  97 */     if (optional.isPresent()) {
/*  98 */       return optional;
/*     */     }
/*     */     
/* 101 */     for (nr nr1 : b()) {
/* 102 */       Optional<T> optional1 = nr1.a(☃);
/* 103 */       if (optional1.isPresent()) {
/* 104 */         return optional1;
/*     */       }
/*     */     } 
/*     */     
...
/*     */   }
/*     */   
/*     */   default <T> Optional<T> b(nu.b<T> ☃, ob ob1) {
/* 112 */     return ☃.accept(ob1, a());
/*     */   }
/*     */   
/*     */   default <T> Optional<T> b(nu.a<T> ☃) {
/* 116 */     return ☃.accept(a());
/*     */   }
/*     */ 
/*     */   
...
/*     */   }
/*     */   
/*     */   static nr a(@Nullable String ☃) {
/* 385 */     return (☃ != null) ? new oe(☃) : oe.d;
/*     */   }
/*     */   
/*     */   ob c();
/*     */   
